...
class Aggo(private val pool: AggoPool) : AutoCloseable {
    ...
    /**
     * Reads all `*.sql` migration files from [migrationsDir] (generated by
     * [com.aggitech.aggo.migration.AggoMigrate.generate]), applies any that
     * have not yet been recorded in `aggo_schema_versions`, and verifies
     * checksums before executing each one.
     *
     * All DDL and version records are committed in a single transaction so the
